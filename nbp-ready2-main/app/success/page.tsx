...
export default function SuccessPage() {
  ...
  return (
    <main className="login-screen flex min-h-screen flex-col items-center justify-center px-2 py-1 sm:px-3 sm:py-3">
      <div className="w-full max-w-[390px]">
        <section className="rounded-3xl bg-white px-3 py-3 shadow-[0_12px_24px_rgba(0,0,0,0.18)] sm:px-4 sm:py-4">
          ...
          <div className="success-badge-wrap mt-1 flex scale-[0.78] items-center justify-center sm:mt-2 sm:scale-90">
          ...
          <div className="verification-notice mt-2">
          ...
          <a
            ...
            className="mt-1 flex items-center gap-2.5 rounded-2xl border border-[#e5e5e5] px-2.5 py-2 transition-colors hover:bg-[#f7f9f7]"
          >
            ...
            <span className="min-w-0 flex-1">
              ...
              <span className="block truncate text-[11px] text-[#8a8a8a]">For more information and assistance</span>
            </span>
            <span className="shrink-0 whitespace-nowrap text-xs font-semibold text-[#0d5228]">+92 300 1234567</span>
            <ChevronRight aria-hidden="true" className="h-4 w-4 shrink-0 text-[#8a8a8a]" />
          </a>

          <div className="info-notice mt-2">
          ...
          <button
            type="button"
            onClick={() => router.push('/')}
            className="mt-2 flex h-11 w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#1f8a4c] to-[#0d5228] text-base font-bold text-white shadow-[0_8px_18px_rgba(16,82,40,0.28)] transition-transform hover:-translate-y-0.5 active:translate-y-0"
          >
